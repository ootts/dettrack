import torch
from disprcnn.modeling.models.yolact.layers.box_utils import decode, jaccard
...
class Detect(object):
    ...
    def traditional_nms(self, boxes, masks, scores, iou_threshold=0.5, conf_thresh=0.05):
        ...
        from disprcnn.modeling.models.yolact.utils.cython_nms import nms as cnms
        ...
        for _cls in range(num_classes):
            ...
            keep = torch.from_numpy(keep).to(device=boxes.device).long()
