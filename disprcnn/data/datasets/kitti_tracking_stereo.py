...
class KITTITrackingStereoDataset(torch.utils.data.Dataset):
    CLASSES = (
        "__background__",
        "car",
        'dontcare'
    ...
    def __init__(self, cfg, root, split, transforms=None, remove_ignore=True, ds_len=-1):
        ...
        cls = KITTITrackingStereoDataset.CLASSES
    ...
    def get_image(self, seq, frameid):
        ...
        right_img = cv2.imread(osp.join(self.root, 'tracking', split, f'image_03/{seq:04d}/{frameid:06d}.png'))
        if self.gray:
